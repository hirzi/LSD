...
##### Example usage: ./GLF_simulater_sumStats.sh -f neutral_demo_simpleModel_11params_RECON2.out -p 20,20,20,20,20,20 -l 5000 -d 2 -e 0.01 -r ${REF_index} -w ${working_dir} -o results.concatenated
