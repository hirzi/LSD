...
# Assign argument to 1) chromosome number or 2) directory name (to parallelise across CPUs).
...
#masterdir <- "/Users/luqman/Downloads/"
masterdir <- "/cluster/work/gdc/shared/p461/secondNGSdataset/Antirrhinum_DataSet/"
#ABC_parent_dir <- "/Users/luqman/Downloads/"
#ABC_parent_dir <- "/cluster/work/gdc/shared/p461/secondNGSdataset/Antirrhinum_DataSet/Estimation_results/nobackup/"
ABC_parent_dir <- "/cluster/work/gdc/shared/p461/secondNGSdataset/ABCEstimator_results/nobackup/"
# Working directories (children)
ABC_results_dir <- "Estimation_results_simpleModel_4params_n1n7_m_4m4_1350k_Chr6_40MB_56MB_region_Joint_retSims6750_gridPoints33/"
...
#output_dir <- paste0(masterdir)
output_dir <- paste0(masterdir,"GenomeScan_results/")
output_suffix <- "region_40MB_56MB_2pop_simpleModel_retSims6750"
...
neutral_estimate <- c(2.54545, 2.22222, 5.06061, 5.0606) #n1n7_m_4m4_1350k_noPLS_retSims13500
# Joint neutral estimates
#neutral_estimate_2D <- c(3.25000, -3.24999) # jointNeutral Grid #n1n7_m_4m4_1350k_noPLS_retSims13500
neutral_estimate_2D <- c(2.54545, 2.22222) # marginalNeutral #n1n7_m_4m4_1350k_noPLS_retSims13500
# Number of windows per chromosome
num_loci_list <- c(13642) #Chr6_2pops_simpleModel_start20_end55771888_windowsize10000_M2_Q0_zeroSegSitesRemoved_40MB_56MB_subRegion
#num_loci_list <- c(2056) #Chr6_2pops_simpleModel_start20_end55771888_windowsize10000_M2_Q0_zeroSegSitesRemoved_52MB_54MB_subRegion
# List of scaffolds
Chr_scaffold_list <- c("Chr6_2pops_simpleModel_start20_end55771888_windowsize10000_M2_Q0_zeroSegSitesRemoved_40MB_56MB_subRegion.scaffoldlist")
#Chr_scaffold_list <- c("Chr6_2pops_simpleModel_start20_end55771888_windowsize10000_M2_Q0_zeroSegSitesRemoved_52MB_54MB_subRegion.scaffoldlist")
...
for (i in ABC_output_files_joint[idx_loci_passed_joint]) {
  ...
  if (joint.type == "grid") {
    # Recall that there are points above the diagonal, below the diagonal and on the diagonal. To reduce degrees of freedom, we first account for the points on the diagonal (i.e. where _m_MP2_YP1=m_YP1_MP2).
...
window_pos<-read.delim(Chr_scaffold_list[Chr], sep = "l", header = FALSE)
