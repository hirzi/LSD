...
### NOTES
# Note 0: For non-pooled data, invariant sites should be set to false (since we simulate invariant errors according to a pooling scheme). Thus, high-coverage is a requirement for using individual data with lsd_high.
