...
version = "LSD-high version: 22_03_2019"
...
# This script contains the main function (lines 168-658), and the wrapper function (lines 659-687) that runs the lsd_high_simulat function and summary statistics calculator function (imported), given a list of supplied arguments (on the command line).
...
### NOTES
# Note 0: For non-pooled data, invariant sites should be set to false (since we simulate invariant errors according to a pooling scheme). Thus, high-coverage is a requirement for using individual data with LSD-high.
